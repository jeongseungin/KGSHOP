...
<body>
	 <div class="container"><!-- 좌우측의 공간 확보 -->
            ...
            <!--// 헤더 들어가는 부분 -->
				...
				<div class="col-lg-10" >
					<input type="text" class="form-control" id="pw_answer"
                ...
                <div class="form-group" id="divPhoneNumber">
                    <label for="inputPhoneNumber" class="col-lg-2 control-label">우편번호</label> 	
    
                    <div class="col-lg-10">
                        <input type="text" class="form-control onlyNumber" data-rule-required="true" placeholder="우편번호" style="width: 100px;" name="addr"><input type="button" value="우편번호" onclick="sample6_execDaumPostcode()"  >
                    </div>
                </div>
				<div class="form-group" id="divPhoneNumber">
				...
				<div class="form-group" id="divPhoneNumber">
                    ...
                    <div class="col-lg-10">
                        <input type="tel" class="form-control onlyNumber" data-rule-required="true" placeholder="상세주소" maxlength="11"  name="addr2" id="sample6_detailAddress">
                    </div>
                </div>
				<div class="form-group" id="divPhoneNumber">
