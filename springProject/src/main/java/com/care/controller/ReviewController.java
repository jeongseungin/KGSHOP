...
public class ReviewController {
		...
		public String savedata(ReviewDTO dto) {
			int i;
		...
		public String updateView(ReviewDTO dto, @ModelAttribute("scri") Board_qaSearchCriteria scri,Model model) throws Exception{
